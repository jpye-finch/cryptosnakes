...
<footer class="dark:bg-gray-800 w-full py-8">
    <div class="max-w-full mx-auto px-0">
        <div class="pt-2 flex max-w-xs mx-auto items-center justify-center">
            <a href="#" class="px-4 text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
